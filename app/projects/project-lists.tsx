...
export default function ProjectLists() {
    return (
        <div>
            <AnimatedSection>
                <div id="project-lists" className="w-9/10 md:max-w-2xl lg:max-w-7xl mx-auto py-20 flex flex-col gap-10">
                    ...
                    <AnimatedSection>
                        <div className="flex flex-col lg:flex-row md:gap-10 gap-6">
                            ...
                            <div className="w-full lg:w-1/2 flex flex-col gap-5">
                                ...
                                <div className="flex gap-2 text-md font-semibold flex-wrap">
                                ...
                                <div className="flex md:gap-10 gap-6 md:pt-10 pt-6">
                    ...
                    <AnimatedSection>
                        <div className="flex flex-col-reverse lg:flex-row md:gap-10 gap-6 md:pt-10 pt-6">
                            <div className="w-full lg:w-1/2 flex flex-col lg:items-end gap-5">
                                <div className="flex items-center lg:justify-start lg:flex-row-reverse gap-2">
                                    <h1 className="text-muted-foreground text-xs">FULL STACK</h1>
                                    <div className="h-px w-8 bg-[#363636]"></div>
                                </div>
                                ...
                                <div className="flex md:flex-row lg:justify-end gap-2 text-md font-semibold flex-wrap">
                                ...
                                <div className="flex md:gap-10 gap-6 lg:flex-row lg:justify-end flex-row-reverse justify-end md:pt-10 pt-6">
                    ...
                    <AnimatedSection>
                        <div className="flex flex-col lg:flex-row md:gap-10 gap-6 md:pt-10 pt-6">
                            <div className="w-full lg:w-1/2">
